...
<div class="footertext" style="margin-left:530px; margin-top:45px;"><a href="abg.php">ABG</a></div>
<div class="footertext" style="margin-left:600px; margin-top:45px;"><a href="impressum.php">Impressum</a></div>

<div class="footertext" style="margin-left:800px; margin-top:40px;"><a href="mailto:info@ventura-personal.de" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('mail','','img/button-mail-m.png',1)"><img src="img/button-mail.png" alt="E-Mail" width="42" height="30" id="mail" /></a></div>
